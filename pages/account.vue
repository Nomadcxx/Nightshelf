<template>
  <div class="w-full h-full p-4">
    ...
    <div class="flex justify-center items-center my-4 left-0 right-0 bottom-0 absolute">
      <p class="text-sm text-fg">{{ $strings.MessageReportBugsAndContribute }} <a class="underline" href="https://github.com/Nomadcxx/audiobookshelf-app" target="_blank">GitHub</a></p>
      <a href="https://github.com/Nomadcxx/audiobookshelf-app" target="_blank" class="text-fg hover:scale-150 hover:rotate-6 transform duration-500 ml-2">
